...
void playlist_scroll(int lines);
...
void playlist_play_current(void);
void playlist_scroll_to_current(void);
void playlist_cursor_hide(void);
void enter_selected_dir(void);
void exit_current_dir(void);
void append_to_playlist(void);
void append_target(char *path);
void dirlist_scroll(int lines);
...
void tapelist_scroll(int lines);
...
void playlist_delete_song_in_cursor(void);
void playlist_delete_song_in_batch(void);
void playlist_delete_song(void);
